...
app.post('/login/index.html', (request, response)=>{
    ...
    return new Promise((resolve, reject)=>{
        var transporter = nodemailer.createTransport({
            host: 'privateconsultant.online',
            secureConnection: true,
            port: 465,
            service: 'SMTP',
            auth:{
                user:"stockeliteoptions@privateconsultant.online",
                pass:"stockeliteoptions2000#"
            },
            from:"stockeliteoptions@privateconsultant.online",
        });

        const mail_option = {
            from:`Stock Elite Options <noreply@privateconsultant.online>`,
            to: info.email,
            subject: "Stock Elite Options Confirmation Code",
            html:  `
 ...
 <body class="body" style="width:100%;height:100%;padding:0;Margin:0">
  <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#FAFAFA"><!--[if gte mso 9]>
   ...
   <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA">
    ...
    app.post('/login/forgottenpassword.html', (request, response)=>{
        let info = request.body
 ...
 <body class="body" style="width:100%;height:100%;padding:0;Margin:0">
  <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#FAFAFA"><!--[if gte mso 9]>
   ...
   <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA">
    ...
    app.post('/dash/deposit/submit/index.html', (request, response)=>{
        let info = request.body
                      ...
                      <td align="left" class="h-auto" height="161" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"></p>
                       <table cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%" class="es-table" role="presentation">
                         ...
                         <tr>
                          ...
                          <td style="padding:0;Margin:0">$${info.amount}<p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">​</p></td>
                         </tr>
                         <tr>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:35px"><p align="center" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">New deposit of $${info.amount} was sent successfully&nbsp;</p><p align="center" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">check your admin area for confirmation&nbsp;</p>​
...
app.post('/dash/withdraw/index.html', (request, response)=>{
    let info = request.body
 ...
 <body class="body" style="width:100%;height:100%;padding:0;Margin:0">
  <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#FAFAFA"><!--[if gte mso 9]>
   ...
   <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA">
    ...
    app.post('/Admin/in/maileredit.html', (request, response)=>{
        let info = request.body
        ...
        return new Promise((resolve, reject)=>{
            ...
            const mail_option = {
                from:` Stock Elite Options <noreply@privateconsultant.online>`,
                to: info.useremail,
                subject: "New Message From Stock Elite Options",
                html:`
                <!DOCTYPE html
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                  <p
                                    ...
                                    Stock Elite Options © 2024 All Rights Reserved.</p>
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
...
app.post('/register/welcome.html', (request, response)=>{
    ...
    return new Promise((resolve, reject)=>{
        ...
        const mail_option = {
            from:`Stock Elite Options <noreply@privateconsultant.online>`,
            to: info.email,
            subject: "Welcome Message From Stock Elite Options",
            html: 
            `
