var perPage = 8,
    options = {
        valueNames: ["id", "name", "currency_name", "form_name", "date", "details", "transaction_id", "type", "amount", "status"],
        page: perPage,
        pagination: !0,
    ...
    swiper = (isCount = (new DOMParser).parseFromString(contactList.items.slice(-1)[0]._values.id, "text/html"), document.querySelector(".pagination-next") && document.querySelector(".pagination-next").addEventListener("click", function() {
